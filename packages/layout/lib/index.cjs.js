...
var relayoutPage = fns.asyncCompose(
  resolveAssets,
  resolveTextLayout,
  resolveInheritance,
...
var resolveDynamicPage = /*#__PURE__*/ (function() {
  var _ref = _asyncToGenerator__default['default'](
    /*#__PURE__*/ _regeneratorRuntime__default['default']().mark(
      function _callee(props, page, fontStore) {
        var resolvedPage, relayoutedPage;
        return _regeneratorRuntime__default['default']().wrap(function _callee$(
          _context,
        ) {
          while (1)
            switch ((_context.prev = _context.next)) {
              case 0:
                ...
                resolvedPage = resolveDynamicNodes(props, page);
                _context.next = 4;
                return relayoutPage(resolvedPage, fontStore);
              case 4:
                relayoutedPage = _context.sent;
                return _context.abrupt('return', relayoutedPage);
              case 6:
  ...
  return function resolveDynamicPage(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
})();
var splitPage = /*#__PURE__*/ (function() {
  var _ref2 = _asyncToGenerator__default['default'](
    /*#__PURE__*/ _regeneratorRuntime__default['default']().mark(
      function _callee3(page, pageNumber, fontStore) {
        var wrapArea,
          contentArea,
          dynamicPage,
          height,
            ...
            while (1)
              switch ((_context3.prev = _context3.next)) {
                ...
                case 4:
                  ...
                  relayout = /*#__PURE__*/ (function() {
                    var _ref3 = _asyncToGenerator__default['default'](
                      /*#__PURE__*/ _regeneratorRuntime__default[
                        'default'
                      ]().mark(function _callee2(node) {
                        return _regeneratorRuntime__default['default']().wrap(
                    ...
                    return function relayout(_x7) {
                      return _ref3.apply(this, arguments);
                    };
                  })();
                  currentBox = _extends__default['default']({}, page.box, {
                    height: height,
                  });
                  _context3.next = 11;
                  return relayout(
                ...
                case 11:
                  currentPage = _context3.sent;
                  if (!(nextChilds.length === 0 || allFixed(nextChilds))) {
                    _context3.next = 14;
                    break;
                  }
                  return _context3.abrupt('return', [currentPage, null]);
                case 14:
                  nextBox = fns.omit('height', page.box);
                  nextProps = fns.omit('bookmark', page.props);
                  _context3.next = 18;
                  return relayout(
                    Object.assign({}, page, {
                      props: nextProps,
                ...
                case 18:
                  ...
                  return _context3.abrupt('return', [currentPage, nextPage]);
                case 20:
                case 'end':
  ...
  return function splitPage(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
})();
var resolvePageIndices = /*#__PURE__*/ (function() {
  var _ref4 = _asyncToGenerator__default['default'](
    /*#__PURE__*/ _regeneratorRuntime__default['default']().mark(
      function _callee4(fontStore, page, pageNumber, pages) {
              ...
              switch ((_context4.prev = _context4.next)) {
                case 0:
                  ...
                  return _context4.abrupt(
                    'return',
                    resolveDynamicPage(props, page, fontStore),
                  );
                case 3:
                case 'end':
  ...
  return function resolvePageIndices(_x8, _x9, _x10, _x11) {
...
var paginate = /*#__PURE__*/ (function() {
  var _ref5 = _asyncToGenerator__default['default'](
    /*#__PURE__*/ _regeneratorRuntime__default['default']().mark(
      function _callee5(page, pageNumber, fontStore) {
        var _page$props;
        var splittedPage, pages, nextPage;
        return _regeneratorRuntime__default['default']().wrap(
          function _callee5$(_context5) {
            while (1)
              switch ((_context5.prev = _context5.next)) {
                ...
                case 4:
                  _context5.next = 6;
                  return splitPage(page, pageNumber, fontStore);
                case 6:
                  splittedPage = _context5.sent;
                  pages = [splittedPage[0]];
  ...
  return function paginate(_x12, _x13, _x14) {
 ...
 * @returns {Object} layout node
 */
var resolvePagination = /*#__PURE__*/ (function() {
  var _ref6 = _asyncToGenerator__default['default'](
    /*#__PURE__*/ _regeneratorRuntime__default['default']().mark(
      function _callee8(doc, fontStore) {
              ...
              switch ((_context8.prev = _context8.next)) {
                case 0:
                  ...
                  return Promise.all(
                    doc.children.map(
                      /*#__PURE__*/ (function() {
                        var _ref7 = _asyncToGenerator__default['default'](
                          /*#__PURE__*/ _regeneratorRuntime__default[
                            'default'
                          ]().mark(function _callee6(page) {
                            var _pages;
                            var subpages;
                              ...
                              while (1)
                                switch ((_context7.prev = _context7.next)) {
                                  case 0:
                                    ...
                                    _context7.t0 = dissocSubPageData;
                                    _context7.next = 4;
                                    return resolvePageIndices.apply(
                                      void 0,
                                      [fontStore].concat(args),
                                    );
                                  case 4:
                ...
                case 6:
                  ...
                  return _context8.abrupt('return', assingChildren(pages, doc));
                case 8:
                case 'end':
  ...
  return function resolvePagination(_x15, _x16) {
