      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1)
          switch ((_context3.prev = _context3.next)) {
            ...
            case 14:
              nextBox = omit('height', page.box);
              nextProps = omit('bookmark', page.props);
              _context3.next = 18;
              return relayout(
                Object.assign({}, page, {
                  props: nextProps,
        ...
        while (1)
          switch ((_context5.prev = _context5.next)) {
            ...
            case 9:
              ...
              _context5.next = 12;
              return splitPage(nextPage, pageNumber + pages.length, fontStore);
            case 12:
              splittedPage = _context5.sent;
...
var resolvePagination = /*#__PURE__*/ (function() {
  var _ref6 = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime().mark(function _callee8(doc, fontStore) {
                          ...
                          return _regeneratorRuntime().wrap(function _callee6$(
                            ...
                            while (1)
                              switch ((_context6.prev = _context6.next)) {
                                case 0:
                                  _context6.next = 2;
                                  return paginate(page, pageNumber, fontStore);
                                case 2:
                                  subpages = _context6.sent;
                                  subpages = assocSubPageData(subpages);
                                  pageNumber += subpages.length;
                                  (_pages = pages).push.apply(_pages, subpages);
                                case 6:
                                case 'end':
