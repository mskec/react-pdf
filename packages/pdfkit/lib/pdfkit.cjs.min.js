...
var g,
    ...
    function a(a, t, r) {
      ...
      return (
        ((c =
          ...
          this).finalize = c.finalize.bind(O.default(c))),
        (c.document = a),
        (c.id = t),
        null == r && (r = {}),
        (c.data = r),
    ...
    return (
      (t.initDeflate = function() {
        ...
        return (
          ...
          (this.deflate = T.default.createDeflate()),
      ...
      (t.finalize = function() {
        if (
          ...
          this.document._write(q.convert(this.data)),
          this.chunks.length)
        ) {
      ...
      return (
        ...
        (a.toString = function() {
          ...
          if (this.limits && a.length > 1) {
            ...
            t.push(
              '  /Limits ' +
                q.convert([this._dataForKey(r), this._dataForKey(c)])
            );
          }
          t.push('  /' + this._keysName() + ' [');
          for (var i, n = k.default(a); !(i = n()).done; ) {
            var o = i.value;
            t.push(
              '    ' +
                q.convert(this._dataForKey(o)) +
                ' ' +
                q.convert(this._items[o])
            );
          }
  ...
  q = (function() {
    ...
    return (
      (e.convert = function(a) {
        ...
        if (a instanceof R || a instanceof D) return a.toString();
        if (a instanceof Date)
          return (
            '(D:' +
            B(a.getUTCFullYear(), 4) +
            B(a.getUTCMonth() + 1, 2) +
            B(a.getUTCDate(), 2) +
            B(a.getUTCHours(), 2) +
            B(a.getUTCMinutes(), 2) +
  ...
  V = { top: 0, left: 0, bottom: 0, right: 0 },
  z = {
    '4A0': [4767.87, 6740.79],
    '2A0': [3370.39, 4767.87],
    A0: [2383.94, 3370.39],
  ...
  M = (function() {
    function e(e, a) {
      void 0 === a && (a = {}),
        ...
        (this.margins = V);
      var t = Array.isArray(this.size) ? this.size : z[this.size.toUpperCase()];
      ...
      (a.embed = function(e) {
        ...
        if (0 !== t) {
          ...
          if (
            ...
            for (var l, d = k.default(this.stops); !(l = d()).done; ) {
              var h = l.value;
              m.stop(h[0], [h[2]]);
            }
  ...
  G = { PDFGradient: E, PDFLinearGradient: K, PDFRadialGradient: L },
  H = G.PDFGradient,
  j = G.PDFLinearGradient,
  J = G.PDFRadialGradient,
  X = {
    initColor: function() {
      return (
    ...
    _setColor: function(e, a) {
      ...
      var t = a ? 'SCN' : 'scn';
      if (e instanceof H) this._setColorSpace('Pattern', a), e.apply(t);
      else {
    ...
    linearGradient: function(e, a, t, r) {
      return new j(this, e, a, t, r);
    },
    radialGradient: function(e, a, t, r, c, i) {
      return new J(this, e, a, t, r, c, i);
    }
  },
  Q = {
...
var Z = {
  ...
  re = {
    M: function(e, a) {
      return (
        (g = a[0]), (f = a[1]), (A = v = null), (p = g), (y = f), e.moveTo(g, f)
      );
    },
    m: function(e, a) {
      return (
    ...
    S: function(e, a) {
      return (
        null === A && ((A = g), (v = f)),
        e.bezierCurveTo(g - (A - g), f - (v - f), a[0], a[1], a[2], a[3]),
        (A = a[0]),
        (v = a[1]),
        (g = a[2]),
        (f = a[3])
    ...
    Q: function(e, a) {
      return (
        ...
        (g = a[2]),
        (f = a[3]),
        e.quadraticCurveTo(a[0], a[1], g, f)
      );
    },
    q: function(e, a) {
      return (
        e.quadraticCurveTo(a[0] + g, a[1] + f, a[2] + g, a[3] + f),
        (A = g + a[0]),
        (v = f + a[1]),
        (g += a[2]),
        (f += a[3])
    ...
    T: function(e, a) {
      return (
        null === A
          ? ((A = g), (v = f))
          : ((A = g - (A - g)), (v = f - (v - f))),
        e.quadraticCurveTo(A, v, a[0], a[1]),
        (A = g - (A - g)),
        (v = f - (v - f)),
        (g = a[0]),
        (f = a[1])
    ...
    t: function(e, a) {
      return (
        null === A
          ? ((A = g), (v = f))
          : ((A = g - (A - g)), (v = f - (v - f))),
        e.quadraticCurveTo(A, v, g + a[0], f + a[1]),
        (g += a[0]),
        (f += a[1])
      );
    },
    A: function(e, a) {
      return ce(e, g, f, a), (g = a[5]), (f = a[6]);
    },
    a: function(e, a) {
      return (a[5] += g), (a[6] += f), ce(e, g, f, a), (g = a[5]), (f = a[6]);
    },
    L: function(e, a) {
      return (g = a[0]), (f = a[1]), (A = v = null), e.lineTo(g, f);
    },
    l: function(e, a) {
      return (g += a[0]), (f += a[1]), (A = v = null), e.lineTo(g, f);
    },
    H: function(e, a) {
      return (g = a[0]), (A = v = null), e.lineTo(g, f);
    },
    h: function(e, a) {
      return (g += a[0]), (A = v = null), e.lineTo(g, f);
    },
    V: function(e, a) {
      return (f = a[0]), (A = v = null), e.lineTo(g, f);
    },
    v: function(e, a) {
      return (f += a[0]), (A = v = null), e.lineTo(g, f);
    },
    Z: function(e) {
      return e.closePath(), (g = p), (f = y);
    },
    z: function(e) {
      return e.closePath(), (g = p), (f = y);
    }
  ...
  ie = function(e, a, t, r, c, i, n, o, s) {
    var u = n * (Math.PI / 180),
      m = Math.sin(u),
      l = Math.cos(u);
    (t = Math.abs(t)), (r = Math.abs(r));
    var d =
      ((A = l * (o - e) * 0.5 + m * (s - a) * 0.5) * A) / (t * t) +
      ((v = l * (s - a) * 0.5 - m * (o - e) * 0.5) * v) / (r * r);
          ...
          for (
            ...
            if (!ee(s))
              if (i && ',' === s) {
                ...
                (r = []),
                  (i = !1),
                  0 === (c = Z[(t = s)]) && a.push({ command: t, args: r });
              } else {
                if (null == t) return a;
                var u = o,
                  m = null;
  ...
  me = {
      ...
      if (Array.isArray(e))
        return (
          (e = Array.from(e)
            ...
            .join(' ')),
          (t = a.phase || 0),
          this.addContent('[' + e + '] ' + q.number(t) + ' d')
        );
      var r = null != a.space ? a.space : e;
      return (
        (t = a.phase || 0),
        this.addContent(
          '[' + q.number(e) + ' ' + q.number(r) + '] ' + q.number(t) + ' d'
        )
      );
    },
    undash: function() {
    ...
    moveTo: function(e, a) {
      return this.addContent(se(e) + ' ' + se(a) + ' m');
    },
    lineTo: function(e, a) {
      return this.addContent(se(e) + ' ' + se(a) + ' l');
    },
    ...
    quadraticCurveTo: function(e, a, t, r) {
      return this.addContent(
        se(e) + ' ' + se(a) + ' ' + se(t) + ' ' + se(r) + ' v'
      );
    },
    rect: function(e, a, t, r) {
      return this.addContent(
        se(e) + ' ' + se(a) + ' ' + se(t) + ' ' + se(r) + ' re'
      );
    },
    roundedRect: function(e, a, t, r, c) {
      null == c && (c = 0);
      var i = (c = Math.min(c, 0.5 * t, 0.5 * r)) * (1 - ue);
      return (
        this.moveTo(e + c, a),
        this.lineTo(e + t - c, a),
...
var he = (function() {
  ...
  ve = (function() {
    ...
    e.open = function(e, a, t, r) {
      var c;
      if ('string' == typeof a) {
        if (pe.isStandardFont(a)) return new pe(e, a, r);
        c = S.openSync(a, t);
      } else
        a instanceof Uint8Array
          ? (c = S.create(a, t))
          : a instanceof ArrayBuffer
          ? (c = S.create(new Uint8Array(a), t))
          : 'object' == typeof a && (c = a);
      if (null == c)
  ...
  Oe = {
    ...
    _glyphs: function(e, a, t, r, c) {
      ...
      this.save(),
        ...
        this.addContent('BT'),
        this.addContent('1 0 0 1 ' + xe(t) + ' ' + xe(r) + ' Tm'),
        this.addContent('/' + this._font.id + ' ' + xe(this._fontSize) + ' Tf');
  ...
  ke = (function() {
    function e(e, a) {
      ...
      for (
        ...
        (r += 2),
        !Array.from(Te).includes(t));

      )
        r += this.data.readUInt16BE(r);
      if (!Array.from(Te).includes(t)) throw 'Invalid JPEG.';
      (r += 2),
    ...
    return (
      (a.embed = function(e) {
        ...
        if (((this.document = e), !this.obj)) {
          ...
          if (null != this.image.transparency.grayscale) {
            ...
            for (
              var o, s = this.image.transparency.rgb, u = [], m = k.default(s);
              !(o = m()).done;
      ...
      (a.splitAlphaChannel = function() {
        ...
        return this.image.decodePixels(function(a) {
          ...
          return (
            (e.imgData = T.default.deflateSync(n)),
            (e.alphaChannel = T.default.deflateSync(o)),
            e.finalize()
          );
        });
      }),
      (a.loadIndexedAlphaChannel = function() {
        ...
        return this.image.decodePixels(function(t) {
          for (
            ...
            r[c++] = a[t[i]];
          return (e.alphaChannel = T.default.deflateSync(r)), e.finalize();
        });
      }),
      (a.decodeData = function() {
        var e = this;
        this.image.decodePixels(function(a) {
          (e.imgData = T.default.deflateSync(a)), e.finalize();
        });
      }),
      e
    );
  ...
  Ue = (function() {
    ...
    return (
      (e.open = function(e, a) {
        ...
        if (255 === t[0] && 216 === t[1]) return new ke(t, a);
  ...
  Se = {
    ...
    image: function(e, a, t, r) {
      ...
      var m = e instanceof Ue ? e : this.embedImage(e);
    ...
    openImage: function(e) {
      ...
      return (
        'string' == typeof e && (a = this._imageRegistry[e]),
        a ||
          ((a = Ue.open(e, 'I' + ++this._imageCount)),
  ...
  we = { top: 0, left: 0, zoom: 0, fit: !1, pageNumber: null, expanded: !1 },
  _e = (function() {
  ...
  Fe = {
    initOutline: function() {
      this.outline = new _e(this, null, null, null);
    },
    endOutline: function() {
  ...
  De = { left: 0, center: 1, right: 2 },
  Pe = { value: 'V', defaultValue: 'DV' },
  We = { zip: '0', zipPlus4: '1', zip4: '1', phone: '2', ssn: '3' },
  Be = {
    nDec: 0,
    sepComma: !1,
    negStyle: 'MinusBlack',
  ...
  Ve = {
    ...
    _resolveJustify: function(e) {
      ...
      return (
        void 0 !== e.align &&
          ('number' == typeof De[e.align] && (a = De[e.align]), delete e.align),
        0 !== a && (e.Q = a),
        e
      );
    },
    ...
    _resolveStrings: function(e) {
      ...
      return (
        ...
        Object.keys(Pe).forEach(function(a) {
          void 0 !== e[a] && ((e[Pe[a]] = e[a]), delete e[a]);
        }),
  ...
  ze = {
    file: function(e, a) {
      ...
      var s,
        u = U.default(F.lib.WordArray.create(new Uint8Array(t)));
      (r.Params.CheckSum = new String(u)),
        (r.Params.Size = t.byteLength),
        this._fileRegistry || (this._fileRegistry = {});
      var m,
        l,
        d = this._fileRegistry[a.name];
      d &&
      ((l = d),
      (m = r).Subtype === l.Subtype &&
        m.Params.CheckSum.toString() === l.Params.CheckSum.toString() &&
        m.Params.Size === l.Params.Size &&
        m.Params.CreationDate === l.Params.CreationDate &&
        m.Params.ModDate === l.Params.ModDate)
        ? (s = d.ref)
        : ((s = this.ref(r)).end(t),
          (this._fileRegistry[a.name] = _.default({}, r, { ref: s })));
      var h = {
        Type: 'Filespec',
        F: new String(a.name),
        EF: { F: s },
      ...
      a.description && (h.Desc = new String(a.description));
      var g = this.ref(h);
      return g.end(), a.hidden || this.addNamedEmbeddedFile(a.name, g), g;
    }
  };
var Me = function(e) {
    ...
    function a(a) {
      ...
      if (
        ...
        t.options.pageLayout &&
          (t._root.data.PageLayout = Me(t.options.pageLayout)),
        t.options.pageMode && (t._root.data.PageMode = Me(t.options.pageMode)),
        (t.page = null),
        t.initColor(),
        t.initVector(),
        t.initFonts(),
...
Ie(X),
  ...
  Ie(Ve),
  Ie(ze),
  (exports.EmbeddedFont = ye),
  (exports.PDFFont = ve),
  (exports.StandardFont = pe),
  (exports.default = Ne);
