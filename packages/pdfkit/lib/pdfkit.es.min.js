...
import i from '@babel/runtime/helpers/createClass';
import n from 'crypto-js/md5';
import * as o from 'fontkit';
import s from 'fs';
import u from '@react-pdf/png-js';
import m from '@babel/runtime/helpers/extends';
import * as l from 'crypto-js/core';
var d,
  h,
  g,
  f,
    ...
    return (
      ...
      (i.finalize = function() {
        if (
          ...
          this.document._write(T.convert(this.data)),
          this.chunks.length)
        ) {
      ...
      return (
        ...
        (a.toString = function() {
          ...
          if (this.limits && a.length > 1) {
            ...
            t.push(
              '  /Limits ' +
                T.convert([this._dataForKey(r), this._dataForKey(i)])
            );
          }
          ...
          for (var n, o = c(a); !(n = o()).done; ) {
            ...
            t.push(
              '    ' +
                T.convert(this._dataForKey(s)) +
                ' ' +
                T.convert(this._items[s])
            );
          }
  ...
  T = (function() {
    ...
    return (
      (e.convert = function(a) {
        ...
        if (a instanceof p || a instanceof y) return a.toString();
  ...
  k = { top: 0, left: 0, bottom: 0, right: 0 },
  C = {
    '4A0': [4767.87, 6740.79],
    '2A0': [3370.39, 4767.87],
    A0: [2383.94, 3370.39],
  ...
  U = (function() {
    function e(e, a) {
      void 0 === a && (a = {}),
        ...
        (this.margins = k);
      var t = Array.isArray(this.size) ? this.size : C[this.size.toUpperCase()];
  ...
  R = { PDFGradient: w, PDFLinearGradient: _, PDFRadialGradient: F },
  D = R.PDFGradient,
  P = R.PDFLinearGradient,
  W = R.PDFRadialGradient,
  B = {
    initColor: function() {
      return (
    ...
    _setColor: function(e, a) {
      ...
      var t = a ? 'SCN' : 'scn';
      if (e instanceof D) this._setColorSpace('Pattern', a), e.apply(t);
      else {
    ...
    linearGradient: function(e, a, t, r) {
      return new P(this, e, a, t, r);
    },
    radialGradient: function(e, a, t, r, c, i) {
      return new W(this, e, a, t, r, c, i);
    }
  },
  V = {
...
var z = {
  ...
  E = {
    M: function(e, a) {
      return (
        (d = a[0]), (h = a[1]), (g = f = null), (A = d), (v = h), e.moveTo(d, h)
      );
    },
    m: function(e, a) {
      return (
    ...
    S: function(e, a) {
      return (
        null === g && ((g = d), (f = h)),
        e.bezierCurveTo(d - (g - d), h - (f - h), a[0], a[1], a[2], a[3]),
        (g = a[0]),
        (f = a[1]),
        (d = a[2]),
        (h = a[3])
    ...
    Q: function(e, a) {
      return (
        ...
        (d = a[2]),
        (h = a[3]),
        e.quadraticCurveTo(a[0], a[1], d, h)
      );
    },
    q: function(e, a) {
      return (
        e.quadraticCurveTo(a[0] + d, a[1] + h, a[2] + d, a[3] + h),
        (g = d + a[0]),
        (f = h + a[1]),
        (d += a[2]),
        (h += a[3])
    ...
    T: function(e, a) {
      return (
        null === g
          ? ((g = d), (f = h))
          : ((g = d - (g - d)), (f = h - (f - h))),
        e.quadraticCurveTo(g, f, a[0], a[1]),
        (g = d - (g - d)),
        (f = h - (f - h)),
        (d = a[0]),
        (h = a[1])
    ...
    t: function(e, a) {
      return (
        null === g
          ? ((g = d), (f = h))
          : ((g = d - (g - d)), (f = h - (f - h))),
        e.quadraticCurveTo(g, f, d + a[0], h + a[1]),
        (d += a[0]),
        (h += a[1])
      );
    },
    A: function(e, a) {
      return K(e, d, h, a), (d = a[5]), (h = a[6]);
    },
    a: function(e, a) {
      return (a[5] += d), (a[6] += h), K(e, d, h, a), (d = a[5]), (h = a[6]);
    },
    L: function(e, a) {
      return (d = a[0]), (h = a[1]), (g = f = null), e.lineTo(d, h);
    },
    l: function(e, a) {
      return (d += a[0]), (h += a[1]), (g = f = null), e.lineTo(d, h);
    },
    H: function(e, a) {
      return (d = a[0]), (g = f = null), e.lineTo(d, h);
    },
    h: function(e, a) {
      return (d += a[0]), (g = f = null), e.lineTo(d, h);
    },
    V: function(e, a) {
      return (h = a[0]), (g = f = null), e.lineTo(d, h);
    },
    v: function(e, a) {
      return (h += a[0]), (g = f = null), e.lineTo(d, h);
    },
    Z: function(e) {
      return e.closePath(), (d = A), (h = v);
    },
    z: function(e) {
      return e.closePath(), (d = A), (h = v);
    }
  ...
  L = function(e, a, t, r, c, i, n, o, s) {
    var u = n * (Math.PI / 180),
      m = Math.sin(u),
      l = Math.cos(u);
    (t = Math.abs(t)), (r = Math.abs(r));
    var d =
      ((g = l * (o - e) * 0.5 + m * (s - a) * 0.5) * g) / (t * t) +
      ((f = l * (s - a) * 0.5 - m * (o - e) * 0.5) * f) / (r * r);
  ...
  X = {
      ...
      if (Array.isArray(e))
        return (
          (e = Array.from(e)
            ...
            .join(' ')),
          (t = a.phase || 0),
          this.addContent('[' + e + '] ' + T.number(t) + ' d')
        );
      var r = null != a.space ? a.space : e;
      return (
        (t = a.phase || 0),
        this.addContent(
          '[' + T.number(e) + ' ' + T.number(r) + '] ' + T.number(t) + ' d'
        )
      );
    },
    undash: function() {
    ...
    moveTo: function(e, a) {
      return this.addContent(j(e) + ' ' + j(a) + ' m');
    },
    lineTo: function(e, a) {
      return this.addContent(j(e) + ' ' + j(a) + ' l');
    },
...
var $ = (function() {
    ...
    (e.open = function(a) {
      return new e(s.readFileSync(a, 'utf8'));
    }),
  ...
  re = (function() {
    ...
    e.open = function(e, a, t, r) {
      var c;
      if ('string' == typeof a) {
        if (ce.isStandardFont(a)) return new ce(e, a, r);
        c = o.openSync(a, t);
      } else
        a instanceof Uint8Array
          ? (c = o.create(a, t))
          : a instanceof ArrayBuffer
          ? (c = o.create(new Uint8Array(a), t))
          : 'object' == typeof a && (c = a);
      if (null == c)
  ...
  se = {
    ...
    _glyphs: function(e, a, t, r, c) {
      ...
      this.save(),
        ...
        this.addContent('BT'),
        this.addContent('1 0 0 1 ' + oe(t) + ' ' + oe(r) + ' Tm'),
        this.addContent('/' + this._font.id + ' ' + oe(this._fontSize) + ' Tf');
  ...
  me = (function() {
    function e(e, a) {
      ...
      for (
        ...
        (r += 2),
        !Array.from(ue).includes(t));

      )
        r += this.data.readUInt16BE(r);
      if (!Array.from(ue).includes(t)) throw 'Invalid JPEG.';
      (r += 2),
    ...
    return (
      (e.open = function(e, a) {
        ...
        if (Buffer.isBuffer(e)) t = e;
          ...
          else if (!(t = s.readFileSync(e))) return;
        }
        if (255 === t[0] && 216 === t[1]) return new me(t, a);
  ...
  he = {
    ...
    image: function(e, a, t, r) {
      ...
      var m = e instanceof de ? e : this.embedImage(e);
    ...
    openImage: function(e) {
      ...
      return (
        'string' == typeof e && (a = this._imageRegistry[e]),
        a ||
          ((a = de.open(e, 'I' + ++this._imageCount)),
  ...
  fe = { top: 0, left: 0, zoom: 0, fit: !1, pageNumber: null, expanded: !1 },
  Ae = (function() {
  ...
  ve = {
    initOutline: function() {
      this.outline = new Ae(this, null, null, null);
    },
    endOutline: function() {
  ...
  ye = { left: 0, center: 1, right: 2 },
  be = { value: 'V', defaultValue: 'DV' },
  xe = { zip: '0', zipPlus4: '1', zip4: '1', phone: '2', ssn: '3' },
  Oe = {
    nDec: 0,
    sepComma: !1,
    negStyle: 'MinusBlack',
  ...
  ke = {
    ...
    _resolveJustify: function(e) {
      ...
      return (
        void 0 !== e.align &&
          ('number' == typeof ye[e.align] && (a = ye[e.align]), delete e.align),
        0 !== a && (e.Q = a),
        e
      );
    },
    ...
    _resolveStrings: function(e) {
      ...
      return (
        ...
        Object.keys(be).forEach(function(a) {
          void 0 !== e[a] && ((e[be[a]] = e[a]), delete e[a]);
        }),
    ...
    file: function(e, a) {
      ...
      if (Buffer.isBuffer(e)) t = e;
        ...
        if ((c = /^data:(.*);base64,(.*)$/.exec(e)))
          ...
          if (!(t = s.readFileSync(e)))
            throw new Error('Could not read contents of file at filepath ' + e);
          var i = s.statSync(e),
            o = i.birthtime,
            u = i.ctime;
          (r.Params.CreationDate = o), (r.Params.ModDate = u);
        }
      }
      ...
      var d,
        h = n(l.lib.WordArray.create(new Uint8Array(t)));
      (r.Params.CheckSum = new String(h)),
        (r.Params.Size = t.byteLength),
        this._fileRegistry || (this._fileRegistry = {});
      var g,
        f,
        A = this._fileRegistry[a.name];
      A &&
      ((f = A),
      (g = r).Subtype === f.Subtype &&
        g.Params.CheckSum.toString() === f.Params.CheckSum.toString() &&
        g.Params.Size === f.Params.Size &&
        g.Params.CreationDate === f.Params.CreationDate &&
        g.Params.ModDate === f.Params.ModDate)
        ? (d = A.ref)
        : ((d = this.ref(r)).end(t),
          (this._fileRegistry[a.name] = m({}, r, { ref: d })));
      var v = {
        Type: 'Filespec',
        F: new String(a.name),
        EF: { F: d },
      ...
      a.description && (v.Desc = new String(a.description));
      var p = this.ref(v);
      return p.end(), a.hidden || this.addNamedEmbeddedFile(a.name, p), p;
    }
  };
var Ue = function(e) {
    ...
    function t(e) {
      ...
      if (
        ...
        t.options.pageLayout &&
          (t._root.data.PageLayout = Ue(t.options.pageLayout)),
        t.options.pageMode && (t._root.data.PageMode = Ue(t.options.pageMode)),
        (t.page = null),
        t.initColor(),
        t.initVector(),
        t.initFonts(),
  ...
  Ye = function(e) {
    Object.assign(Se.prototype, e);
  };
Ye(B), Ye(X), Ye(ne), Ye(se), Ye(he), Ye(ge), Ye(ve), Ye(ke), Ye(Ce);
export { ie as EmbeddedFont, re as PDFFont, ce as StandardFont, Se as default };
