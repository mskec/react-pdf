...
(function(module) {
  module.exports = function $$$reconciler($$$hostConfig) {
    ...
    function xc(a, b) {
      ...
      Pa
        ? (z(sc, c._currentValue), (c._currentValue = b))
        : (z(sc, c._currentValue2), (c._currentValue2 = b));
    }
    function yc(a) {
      var b = sc.current;
      y(sc);
    ...
    function ed(a) {
      ...
      function h(b, a, c, d) {
        if (null !== a && a.elementType === c.type)
          return (d = e(a, c.props)), (d.ref = cd(b, a, c)), (d.return = b), d;
            ...
            case ca:
              a: {
                ...
                for (k = d; null !== k; ) {
                  if (k.key === l) {
                    if (
                      7 === k.tag ? f.type === ea : k.elementType === f.type
                    ) {
                      c(a, k.sibling);
    ...
    if (Qa)
        ...
        for (var e = b.child; null !== e; ) {
          if (5 === e.tag) {
            ...
            if (
              ...
              if (
                null !== g &&
                (null !== g.child && ((g.child.return = g), _Ge(a, g, !0, f)),
                (f = g.sibling),
                null !== f)
              ) {
                f.return = e;
      ...
      (He = function He() {}), (Ie = function Ie() {}), (Je = function Je() {});
    function Le(a, b) {
      switch (a.tailMode) {
        case 'hidden':
          b = a.tail;
    ...
    var vg = {
      ...
      attemptHydrationAtCurrentPriority: function attemptHydrationAtCurrentPriority(
        a,
      ) {
        if (13 === a.tag) {
          var b = G();
...
var renderToFile = /*#__PURE__*/ (function() {
  var _ref2 = _asyncToGenerator__default['default'](
    /*#__PURE__*/ _regeneratorRuntime__default['default']().mark(
      function _callee2(element, filePath, callback) {
        var output, stream;
        return _regeneratorRuntime__default['default']().wrap(
          function _callee2$(_context2) {
            while (1)
